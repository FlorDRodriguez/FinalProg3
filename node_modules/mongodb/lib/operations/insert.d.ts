...
export declare class InsertOneOperation extends InsertOperation {
    ...
    execute(server: Server, session: ClientSession | undefined): Promise<InsertOneResult>;
}
/** @public */
...
export declare class InsertManyOperation extends AbstractOperation<InsertManyResult> {
    ...
    execute(server: Server, session: ClientSession | undefined): Promise<InsertManyResult>;
}
