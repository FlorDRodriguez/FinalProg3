...
/** @internal */
declare const kDecorateResult: unique symbol;
/**
...
export declare class AutoEncrypter {
     ...
     */
    teardown(force: boolean): Promise<void>;
    /**
     * Encrypt a command for a given namespace.
     */
    encrypt(ns: string, cmd: Document, options?: CommandOptions): Promise<Document | Uint8Array>;
    /**
     * Decrypt a command response
     */
    decrypt(response: Uint8Array | Document, options?: CommandOptions): Promise<Document>;
    /**
