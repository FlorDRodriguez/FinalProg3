...
export declare class StateMachine {
     ...
     */
    execute<T extends Document>(executor: StateMachineExecutable, context: MongoCryptContext): Promise<T>;
    /**
    ...
    requests(context: MongoCryptContext): Generator<Promise<void>, void, unknown>;
    /**
     ...
     */
    fetchCollectionInfo(client: MongoClient, ns: string, filter: Document): Promise<Uint8Array | null>;
    /**
     ...
     */
    markCommand(client: MongoClient, ns: string, command: Uint8Array): Promise<Uint8Array>;
    /**
     ...
     */
    fetchKeys(client: MongoClient, keyVaultNamespace: string, filter: Uint8Array): Promise<Array<DataKey>>;
}
